...
public:
    ...
    void BuscarInodo(string ruta, int inicio, int posicion);
    void BuscarBloque(string ruta, int inicio, int posicion, bool tipo, int soycero);
    void BorarBitmap(structs::SuperBloque sp, int posicion, bool InodoBloque);
